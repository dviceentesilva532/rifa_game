...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QSize(500, 433))
        MainWindow.setMaximumSize(QSize(500, 433))
        ...
        self.centralwidget.setMaximumSize(QSize(500, 400))
        self.verticalLayoutWidget = QWidget(self.centralwidget)
        self.verticalLayoutWidget.setObjectName(u"verticalLayoutWidget")
        self.verticalLayoutWidget.setGeometry(QRect(-6, 10, 501, 381))
        self.box = QVBoxLayout(self.verticalLayoutWidget)
        self.box.setObjectName(u"box")
        self.box.setSizeConstraint(QLayout.SizeConstraint.SetMaximumSize)
